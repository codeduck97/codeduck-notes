转载于：[click here](https://mp.weixin.qq.com/mp/homepage?__biz=MzU4ODI1MjA3NQ==&hid=12&sn=d17be36eb709b36ab07e172492a99f70&scene=18&uin=&key=&devicetype=Windows+10+x64&version=6302019a&lang=zh_CN&ascene=7&fontgear=2)
...
```
useradd codeduck 						创建⽤户
userdel -r codeduck 					删除⽤户
usermod -g group_name user_name 		修改⽤户的组
usermod -aG group_name user_name 		将⽤户添加到组
usermod -s /bin/ksh -d /home/codepig –g dev codeduck	
										修改⽤户codeduck的登录Shell、主⽬录以及⽤户组
...
passwd 									修改⼝令
passwd codeduck 						修改某⽤户的⼝令
w 										查看活动⽤户
id codeduck 							查看指定⽤户codesheep信息
last 									查看⽤户登录⽇志
...
grep codeduck hello.txt 				在⽂件hello.txt中查找关键词codeduck
grep ^duck hello.txt 					在⽂件hello.txt中查找以duck开头的内容
